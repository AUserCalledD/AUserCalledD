...
---
# CICLYST SERVICE DATA
THIS IS A MODIFIED TEMPLATE FROM THE GOOGLE DATA ANALYST COURSE.
It`s fictional data.
...
It is used read_csv() function with the Q1 2020 and the Q1 2019 csv files from [here](https://divvy-tripdata.s3.amazonaws.com/index.html),
```{r}
q1_2019<-read_csv("/kaggle/input/divvy-trips-2019-2020-q1/Divvy_Trips_2019_Q1.csv" )
q1_2020 <-read_csv("/kaggle/input/divvy-trips-2019-2020-q1/Divvy_Trips_2020_Q1.csv")
...
While the names dont have to be in the same order, they DO need to match perfectly before
...
table(all_trips$member_casual)# Check to make sure the proper number of observations were reassigned
```
...
rides 
write.csv(rides, file = 'number_of_rides.csv')
```